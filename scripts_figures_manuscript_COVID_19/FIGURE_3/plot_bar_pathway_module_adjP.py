...
replaces={"Posttranslational regulation of adherens junction stability and dissassembly":"Posttranslational regulation of adherens junction",\
          'HDR through Homologous Recombination (HRR) or Single Strand Annealing (SSA)':'HDR through HRR or SSA',\
          "Regulation of nuclear beta catenin signaling and target gene transcription":"Regulation of nuclear beta catenin signaling",\
          "Lissencephaly gene (LIS1) in neuronal migration and development":"LIS1 in neuronal migration and development",\
          ...
          "Glycosaminoglycan biosynthesis - chondroitin sulfate / dermatan sulfate":"Glycosaminoglycan biosynthesis",\
          "Heterotrimeric G-protein signaling pathway-Gq alpha and Go alpha mediated pathway":"Gq alpha and Go alpha mediated pathway",\
          "Heterotrimeric G-protein signaling pathway-Gi alpha and Gs alpha mediated pathway":"Gi alpha and Gs alpha mediated pathway",\
          "Thrombin signalling through proteinase activated receptors (PARs)":"Thrombin signalling through PARs"
          }
ylab=[]
for p in path:
  print (p)
  if p in replaces:
    ylab.append(p.replace(p, replaces[p]))
...
ax0.tick_params(axis='y', which='major', labelsize=30, direction="in")
